...
def split_order_endpoint():
    try:
        ...
        logger.error(f"Error en split_order_endpoint: {e}")
...
def get_employees():
    try:
        ...
        logger.error(f"Error en get_employees: {e}")
        return jsonify({"error": "Error interno"}), 500
...
def trigger_update():
    try:
        ...
        logger.error(f"Error en trigger_update: {e}")
        return jsonify({"error": "Error interno"}), 500
...
def remove_items_endpoint():
    try:
        ...
        logger.error(f"Error en remove_items_endpoint: {e}")
        return jsonify({"error": "Error interno"}), 500
...
def update_enroll_progress():
    try:
        ...
        logger.error(f"Error en update_enroll_progress: {e}")
        return jsonify({"error": "Error interno"}), 500
...
def biometric_status():
    try:
        ...
        logger.error(f"Error en biometric_status: {e}")
        return jsonify({"error": "Error interno"}), 500
...
def biometric_enroll_success():
    try:
        ...
        logger.error(f"Error en biometric_enroll_success: {e}")
        return jsonify({"error": "Error interno"}), 500
...
def check_enroll():
    try:
        ...
        return jsonify({
            "status": "in_progress", 
            "step": worker.enroll_status.get('step', 0),
            "message": worker.enroll_status.get('message', '')
        })
    except Exception as e:
        logger.error(f"Error en check_enroll: {e}")
        return jsonify({"error": "Error interno"}), 500
...
def start_enroll_mode():
    try:
        ...
        logger.error(f"Error en start_enroll_mode: {e}")
        return jsonify({"error": "Error interno"}), 500
...
def start_clear_mode():
    try:
        ...
        logger.error(f"Error en start_clear_mode: {e}")
        return jsonify({"error": "Error interno"}), 500
...
def biometric_clear_success():
    try:
        ...
        logger.error(f"Error en biometric_clear_success: {e}")
        return jsonify({"error": "Error interno"}), 500
...
def update_item_note_endpoint():
    try:
        ...
        logger.error(f"Error en update_item_note_endpoint: {e}")
        return jsonify({"error": "Error interno"}), 500