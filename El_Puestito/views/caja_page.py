...
class CajaPage(QWidget):
    ...
    def cobrar_cuenta(self):
        ...
        if mesa_key and mesa_key in self.ordenes_activas:
            try:
                orden_guardada = self.app_controller.data_manager.complete_order(mesa_key)
    ...
    def refrescar_vista_actual(self):
        """
        Un método helper que simplemente vuelve a cargar la vista
        de la mesa seleccionada actualmente.
        """
